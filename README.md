...
- **`ehr-database:`** a full-stack clinical data management system built with Flask and PostgreSQL that manages patients, providers, visits, diagnoses, prescriptions, and medications, including allergy conflict detection and clinical reports
- **`disease-encyclopedia:`** a searchable Flask web app covering 10 chronic and infectious diseases, with server-side search, detailed condition profiles, and helpful video resources
- **`cancer-drug-sensitivity-predictor:`** machine learning models that predict cancer cell line sensitivity to 266 drugs using gene expression data; features Ridge, LASSO, logistic regression, and neural networks built from scratch in PyTorch 
